trigger CSUOEE_HandleInvoiceConfirmationSend on csuoee__Noncredit_Invoice_Line_Item__c (after insert, after update ) {
    ...
    List<csuoee__Noncredit_Invoice__c> invoicesToComplete = [select Id, csuoee__Contact__c, csuoee__Fulfilled_Email_Sent__c from csuoee__Noncredit_Invoice__c where Id in :invoiceIds and csuoee__Is_Completely_Fulfilled__c = true and csuoee__Fulfilled_Email_Sent__c = false];
